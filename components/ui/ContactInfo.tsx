...
export default function ContactInfo({ contact }: { contact?: CareerContact }) {
  ...
  return (
    <div className="mt-12 p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-200">
      <h3 className="text-2xl font-semibold mb-4">連絡先</h3>
      <div className="space-y-3">
        ...
        {contact.twitter && (
          <p className="flex items-center group">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-gray-600" viewBox="0 0 24 24" fill="currentColor">
